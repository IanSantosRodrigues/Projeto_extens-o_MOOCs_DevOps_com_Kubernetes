...
\title{\color{secondary}\Huge\textbf{Solução: Exercício 2.4 - Volumes persistentes}}
...
1. Crie um PVC solicitando, por exemplo, \texttt{1Gi}.
2. Monte o PVC em \texttt{/usr/share/nginx/html} ou outro caminho de teste.
